...
namespace Scanner
{
    public class Global
    {
        ...
        public static void Execute(string WorkingDirectory, string sPath, string domain, string username, string pass)
        {
            try
            {
                ...
                // proc.StartInfo.Domain = "GLSMWK12.gram.local";                
                proc.StartInfo.Domain = "gram.local";
