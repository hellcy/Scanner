...
(function ($) {
    ...
    $.fn.dTree = function (options) {
        ...
        return this.each(function () {
            ...
            $(this).on('click', '.plus, .minus, .folder, .folder-open', function () {
    ...
    $.fn.dTree.set_icons = function ($selected) {
        ...
        switch ($selected.attr("class")) {
            case "folder":
                ...
                $selected.siblings("span").removeClass("plus").addClass("minus");   
                break;
            case "folder-open":
                $selected.removeClass("folder-open").addClass("folder");
                $selected.siblings("span").removeClass("minus").addClass("plus");
                break;
            default:
        ...
        //  //  alert(!$selected.prev().attr("class"));
        //    //if (!$selected.parent().children('ul:first').is(':visible')) {
        //    //    $selected.siblings.removeClass("plus").addClass("minus");
        //    //    $selected("span").removeClass("folder").addClass("folder-open");
        //    //}
        //    //else {
        //    //    $selected.siblings.removeClass("minus").addClass("plus");
        //    //    $selected("span").removeClass("folder-open").addClass("folder");
        //    //}
        //}
