...
namespace Scanner.Controllers
{
    public class HomeController : BaseController
    {
        public ActionResult Index()
        {
            ...
            if (Request.QueryString["aebn"] != null)
            {
                if (Request.QueryString["aebn"].ToString() == "367a974c-bf89-4732-803b-7e71d9b3f0f2")
                {
                    ...
                    if (Request.QueryString["nndk"] != null)
                    {
                        ...
                        //LoginUser user = new LoginUser();
                        //user.UserName = "scottz@gram.com.au";
                        //user.Password = "ilikefish";
                        ...
                        if (Session["User"] != null)
                        {
                            ...
                            return RedirectToAction("OrderTrack", "Order");
                        }
                    }
                }
            }
            ...
            if (ViewBag.CurrIP == "::1")
            {
                loginUser.UserName = "scottz@gram.com.au";
                loginUser.Password = "ilikefish";
            }
